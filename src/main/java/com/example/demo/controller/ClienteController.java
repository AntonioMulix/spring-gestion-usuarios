...
public class ClienteController {
    ...
    public ResponseEntity<OutputEntity> guardarCliente(@RequestBody ClienteDTO clienteDTO) {
        OutputEntity<Cliente> out = new OutputEntity<>();
        try {
            Cliente result = clienteService.saveCliente(clienteDTO);
    ...
    public ResponseEntity<OutputEntity> updateCliente(@PathVariable Integer id, @RequestBody ClienteDTO clienteDTO) {
        OutputEntity<Integer> out = new OutputEntity<>();
        try {
            Integer result = clienteService.updateCliente(id, clienteDTO);
